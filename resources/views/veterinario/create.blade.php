@extends('layouts.app')
@section('contenedor')
<form class="row g-3" action="{{url('/veterinario')}}" method="post">
{{csrf_field()}}
  <div class="col-md-6">
    <label for="NumEmpleado" class="form-label">{{'Numero Empleado'}}</label>
    <input type="number" class="form-control" name="NumEmpleado" id="NumEmpleado" value="" maxlength="10" required>
  </div>
  <div class="col-md-12">
